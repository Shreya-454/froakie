  ...
  return (
    <div className='bg-light-blue pb-10 md:pb-20 lg:pb-[133px]'>
      <div className='container max-w-[1204px] xl:px-3 px-6 mx-auto'>
          <PrimaryHeading center className='mb-[89px]'>
          How To Buy
          </PrimaryHeading>
          <div className="custom-lg:flex gap-8 lg:gap-14 custom-xl:gap-[73px] items-center">
            <div className='max-custom-lg:flex justify-center relative'>
              <div className='size-24 rounded-full bg-rich-blue absolute left-0 top-6 opacity-20'></div>
              <div className='size-16 rounded-full bg-rich-blue opacity-20 absolute right-4 top-14'></div>
              <div className='size-8 rounded-full bg-rich-blue opacity-20 bottom-16 left-8 absolute'></div>
